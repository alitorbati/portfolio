...
![Old (left) and new (right)](overview.png)
...
![Old (left) and new (right)](hidden-visible.gif)
...
![New explicit behavior](implicit-explicit.gif)
...
![Old (left) and new (right)](wall-sections.png)
...
![Old (left) and new (right)](ambiguous-guided.gif)
...
![Old (left) and new (right)](cramped-rows.png)
...
![Old (left) and new (right)](mobile-behavior.gif)
