...
![Top: empty cases filled with marketing copy; Bottom: clarity](icons.png)
...
![Left: old titles/icons/colors; Right: new titles](value.png)
...
![Left: nav icons, purple blocks, repetitive CTAs, green section border; Right: none of that](color.jpeg)
...
![Left: old version that just sticks at the top; Right: hides the map](sticky.gif)
